...
PROJECT_DIR="${SCRIPT_DIR}/../../021.slack-lambda-mcp-server"
SRC_DIR="${SCRIPT_DIR}/../../src/021.slack-lambda-mcp-server"
...
echo "Next steps:"
echo "1. Create a Slack app using the manifest file at src/021.slack-lambda-mcp-server/slack-app.json"
